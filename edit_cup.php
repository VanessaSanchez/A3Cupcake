...
$id=$_GET['id'];
                ...
                $savoir = "UPDATE savoir SET link = '$link', text = '$text'  WHERE id = '$id'";
        ...
        ?>
                ...
                <p style="font-size:30px"><?php echo $_POST['name']; ?></p><br>
<a href="mesnews.php" style="font-family: 'Lobster', cursive;font-size:40px;text-decoration:none;color:#15A2D6;">Retour</a><br><br>
        ...
        else
        {
            ...
            $req = mysql_query('SELECT link,text FROM savoir WHERE id="'.$_GET['id'].'"');
            ...
            while($dnn = mysql_fetch_array($req))
            {
              ...
              <?php
                ...
                {
                    ?>
                   <form enctype="multipart/form-data" action="edit_cup.php?id=<?php echo $id; ?>" method="post" accept-charset="utf-8">
    <label for="file">Choisissez une image </label><br><input  style="width:80%;" type="file" name="file" value="" id="file"><br><br>					<br>
		<br>
	
    <label for="name">Votre cupcake </label><br><textarea style="width:80%;" onkeyup="javascript:MaxLengthTextarea(this, 200);" type="text" name="name" value="" id="name"><?php echo $dnn['text']; ?></textarea>
    ...
    <p><input style="width:60%;" type="submit" value="OK"></p><br>			<br>
		<br>
			<br>
