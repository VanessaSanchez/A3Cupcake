...
<br><br><br><br>
	<div class="content">
<p style="font-size:40px;">Mes Cupcakes</p>
...
{
?>
       	<div id="block1"> <p style="font-size:30px;"><?php echo htmlentities($dnn['text'], ENT_QUOTES, 'UTF-8'); ?></p>
                <img src="<?php echo "upload/".$dnn['link']; ?>" width="250" > <br>

           

       
        <a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px; text-decoration:none;color:#15A2D6;"href="voir_cup.php?id=<?php echo $dnn['id']; ?> " >Voir</a>&nbsp;<a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px;text-decoration:none;color:#15A2D6;"href="edit_cup.php?id=<?php echo $dnn['id']; ?> ">Modifier</a>&nbsp;<a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px;text-decoration:none;color:#15A2D6;" href="delete_cup.php?id=<?php echo $dnn['id']; ?> " >Effacer</a>&nbsp;<br><br><br></div>
<?php
}
?>  <div id="clear"></div>   
  		       </div>
