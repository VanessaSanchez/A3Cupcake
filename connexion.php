...
<div class="container">
	...
	<div id="presentation_ordi_connexion">
		...
		<h2>Connecte toi et publie ton plus beau cupcake</h2>
	</div>
...
?>
<h1>Vous etes bien d&eacute;connect&eacute;.</h1><br />
...
?>
<h1>Vous etes bien connect&eacute;.</h1> <br />
<script>setTimeout('window.location.href="index.php"', 1000); </script>
<?php
                }
                else
...
?>
	...
	<p style="font-size:50px;">Connexion</p>
    <form action="connexion.php" method="post">
            <label style="font-size:30px;font-family: 'Indie Flower', cursive;" for="username">Pseudo </label><input style="width:90%;" type="text" name="username" id="username" value="<?php echo htmlentities($ousername, ENT_QUOTES, 'UTF-8'); ?>" /><br /><br />
            <label  style="font-size:30px;font-family: 'Indie Flower', cursive;" for="password">Mot de passe </label><input style="width:90%;" type="password" name="password" id="password" /><br /><br /><br />
            <input style="width:60%;" type="submit" value="OK" /><br /><br />                
    </form>
</div>
<?php
        }
