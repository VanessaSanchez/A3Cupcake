...
<p style="font-size:40px;">Ajoute ton cupcake</p>
<form enctype="multipart/form-data" action="traitement.php" method="post" accept-charset="utf-8">
	<label for="file">Image de votre cupcake</label><br><input style="width:80%;" type="file" name="file" value="" id="file"><br><br><br>
	<label for="name">Votre cupcake </label><br><textarea style="width:80%;" onkeyup="javascript:MaxLengthTextarea(this, 200);" type="text" name="name" value="" id="name"></textarea><br><br>
	<span id="insertHere"></span>
	<input type="hidden" name="userid" value="<?php echo $_SESSION['userid']; ?>" id="userid">
	
	
	<p><input style="width:60%;" type="submit" value="OK"></p><br><br><br></form>
