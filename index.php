...
<a href="inscription.php" style="text-decoration:none;height:15%;font-size:30px;padding-top:17%;">Inscription<img src="icon_5506.png" width="40" height="40"  style="float:right;"></a>
...
<div class="container">
	...
	//On recupere les identifiants, les pseudos et les emails des utilisateurs
	$req = mysql_query('SELECT id,link,text FROM savoir WHERE 1 ORDER BY ID DESC LIMIT 3 ');
	...
	?>
   	...
   	<div id="block1"> 
	      <p style="font-size:40px;"><?php echo htmlentities($dnn['text'], ENT_QUOTES, 'UTF-8'); ?></p>
	           <img src="<?php echo "upload/".$dnn['link']; ?>"  > </div>
