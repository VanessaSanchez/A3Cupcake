...
<title>Liste des utilisateurs</title>
       ...
       <p style="font-size:50px">Liste des plus beaux cupcakes</p>
...
?>
       	<div id="block1"> 
       <div style=""> <p style="font-size:30px;"><?php echo htmlentities($dnn['text'], ENT_QUOTES, 'UTF-8'); ?></p>
                <img src="<?php echo "upload/".$dnn['link']; ?>" width="250" > 

           

       
        <a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px; text-decoration:none;color:#15A2D6;" href="voir_cup.php?id=<?php echo $dnn['id']; ?> " > Voir</a>&nbsp;<a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px; text-decoration:none;color:#15A2D6;" href="edit_cup.php?id=<?php echo $dnn['id']; ?> " >Modifier</a>&nbsp;<a style="font-family: 'Indie Flower', cursive;font-size:30px;margin-left:10px; text-decoration:none;color:#15A2D6;" href="delete_cup.php?id=<?php echo $dnn['id']; ?> " >Effacer</a>&nbsp;<br></div>
      <br> <br> 	</div>
<?php
}}
?>
