...
?><br>
    <div class="content">
	<br><br>
	  <h1 style="font-family: 'Lobster', cursive;">Voici votre cupcake</h1>
		 
	<br><br>

       <img src="<?php echo "upload/".$dnn['link']; ?>" height="350px" >
 <p style="font-size:30px;"><?php echo htmlentities($dnn['text'], ENT_QUOTES, 'UTF-8'); ?></p><br><br>
